...
inoremap <unique> <silent> <Plug>PadLineAbove <C-\><C-O>:<C-U>call padline#PadLineAbove(line('.'), v:count1)<CR>
inoremap <unique> <silent> <Plug>PadLineBelow <C-\><C-O>:<C-U>call padline#PadLineBelow(line('.'), v:count1)<CR>
inoremap <unique> <silent> <Plug>PadLineAround <C-\><C-O>:<C-U>call padline#PadBlockAround(line('.'), line('.'), v:count1)<CR>
...
inoremap <unique> <silent> <Plug>UnpadLineAbove <C-\><C-O>:<C-U>call padline#UnpadLineAbove(line('.'), v:count1)<CR>
inoremap <unique> <silent> <Plug>UnpadLineBelow <C-\><C-O>:<C-U>call padline#UnpadLineBelow(line('.'), v:count1)<CR>
inoremap <unique> <silent> <Plug>UnpadLineAround <C-\><C-O>:<C-U>call padline#UnpadBlockAround(line('.'), line('.'), v:count1)<CR>
